...
var AuthorEndpoint = function () {
    function AuthorEndpoint(bo) {
        (0, _classCallCheck3.default)(this, AuthorEndpoint);
    ...
    (0, _createClass3.default)(AuthorEndpoint, [{
        key: "findAll",
        value: function () {
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                _context3.next = 4;
                                return this._bo.save(newAuthor);
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                _context5.prev = 0;
                                id = request.params.id;
                                authorModify = request.body;
                                _context5.next = 5;
                                return this._bo.update(id, authorModify);
...
exports.default = AuthorEndpoint;